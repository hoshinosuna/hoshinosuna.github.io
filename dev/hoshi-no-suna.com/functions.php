...
if ( ! function_exists( 'onepress_setup' ) ) :
	...
	function onepress_setup() {
		...
		add_image_size( 'onepress-blog-square', 300, 300, true );
...
function onepress_scripts() {
    ...
    /* [add] append request form */
    wp_enqueue_style( 'request-form-style', get_template_directory_uri() . '/assets/css/request-form.css' );
